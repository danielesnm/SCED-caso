...
.pull-right[**Objetos target**<br>- 2 D: pan hamburguesa, salchicha.<br>- 1 SC:  plato sucio.

<br>
**Objetos target**<br>- 4 D: Nivel 1 + tostadora, pañuelos.<br>- 2 SC: Nivel 1 + pan roto.

<br><br>
**Objetos target**<br>- 4 D: Nivel 1 + Nivel 2 + mortadela, cortador de pizza, queso crema, cuchara.<br>- 2 SC: Nivel 1 + Nivel 2 + sandwichera sucia, tenedor en mantequilla.
]
]
...
.pull-right[- 2 sesiones x semana (1:30 hr), 3 semanas.

- Feedback online/offline, centrandonos en errores con distractores y situaciones conflictivas en dos tareas IADL.<br>Objetivo: que el paciente sea consciente de cómo lidiar con ellos y promover la generalización a través de un rango más amplio de actividades y contextos.
...
# .right[Fases de la intervención]  
<br><br><br>
### 1. `r fa("eye", fill = "orange")` el video: `r fa("user-alt", fill = "orange")` id. sus errores y los corrige de manera espontánea.  
<br>
--

### 2. `r fa("eye", fill = "orange")` el video: `r fa("user-friends", fill = "orange")`, guiado para discutir su desempeño y las estrategias para mejorarlo.  
<br>
--

### 3. Si no id. errores ni evoca soluciones, se utiliza la técnica de anticipación guiada y generación de estrategias (Toglia et al. 2010): .orange[ _"parece que has notado algo", "estás reaccionando como si hubieras  vio un error ", "¿qué cosas podrías haber hecho para solucionarlo?", "intenta pensar en situaciones similares; ¿Qué has hecho antes para resolverlas?"_]
...
# .right[Fases de la intervención]  
<br><br><br>
El videofeedback se guió con los principios descritos por Schmidt, et al. (2015):
