...
### .orange[Estudiante Predoctoral.] .fade[Universidad de Granada UGR<br>Granada, España]

#### .orange[Maestria en Diagnóstico y Rehabilitación Neuropsicológica.] .fade[Benemerita Universidad Autónoma de Puebla BUAP<br>Puebla, México]

#### .orange[Licenciatura en Psicología.] .fade[Universidad de Monterrey UDEM<br>Monterrey, México]
...
- Autores como [Miyake et al (2000)](https://pubmed.ncbi.nlm.nih.gov/10945922/), se han centrado en 3 aspectos de las FE: capacidad de **alternar** entre esquemas o tareas mentales, capacidad de **monitorear** y adaptar el comportamiento para ajustarse a un contexto particular, capacidad de **inhibición** de los esquemas/tareas predominantes o de respuestas automáticas. 
...
.right-column[ 
> ## Déficit de conciencia. .pink[Anosognosia]  
...
.center[## .pink[Modelo Dinámico de Conciencia (Toglia & Kirk, 200)]
]
