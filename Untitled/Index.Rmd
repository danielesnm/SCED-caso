...
<img style="border-radius: 50%;" src="https://github.com/danielesnm/SCED-caso/blob/main/Untitled/img/yo.png?raw=true" width="150px"/>

## Daniel Salazar-Frías

### Estudiante Predoctoral

.fade[Universidad de Granada<br>Granada, España]
